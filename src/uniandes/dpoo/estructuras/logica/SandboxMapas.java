...
import java.util.ArrayList; //hace más facil todo
import java.util.Arrays; // toco
import java.util.Collection;
import java.util.HashMap;
import java.util.HashSet;  //para comparar
import java.util.List;
import java.util.Map;
import java.util.Set; //hace más facil todo x2
...
public class SandboxMapas
{
    ...
    public boolean compararValores( String[] otroArreglo )
    {
        ...
        return valoresMapa.containsAll(Arrays.asList(otroArreglo));
    }

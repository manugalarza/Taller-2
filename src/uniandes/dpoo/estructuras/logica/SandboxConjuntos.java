...
import java.util.ArrayList; //no se como no usarlo
...
List<String> lista = getCadenasComoListaInvertida();
    ...
    public void eliminarCadenaSinMayusculasOMinusculas( String cadena )
    {
    	...
    	NavigableSet<String> aEliminar = new TreeSet<>();
    	
    	for (String cadena2 : arbolCadenas) {
    		if (cadena2.toLowerCase().equals(cadenaLower)) {
    			aEliminar.add(cadena2);
    		}
    	}
    	arbolCadenas.removeAll(aEliminar);
    }
